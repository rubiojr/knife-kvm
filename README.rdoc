...
* A special VM template (in QCOW2/RAW) with CentOS/Ubuntu/Fedora and installed. I've got a couple of them to share:
  ...
  These templates have a script that is executed when the OS boots and writes all the ip addresses available in the guest to the /tmp/ip-info file (https://gist.github.com/1405266)
